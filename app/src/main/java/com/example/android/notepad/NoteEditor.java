...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        try {
            ...
            // 格式化为目标格式
            SimpleDateFormat outputFormat = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss a", Locale.US);
            updateTime = outputFormat.format(date);
        ...
        // 保存修改时间
        if (mState == STATE_INSERT){
            values.put(NotePad.Notes.COLUMN_NAME_CREATE_DATE,updateTime);
